...
function ListProducts() {
    ...
    const [items, setItems] = useState([
        { id: 1, name: "Oreo com Nutella", checked: false, quantity: 0, price: 9.5 },
        { id: 2, name: "Nutella", checked: false, quantity: 0, price: 9 },
        { id: 3, name: "KitKat", checked: false, quantity: 0, price: 9.5 },
        { id: 4, name: "Doce de Leite", checked: false, quantity: 0, price: 8.5 },
        { id: 5, name: "Clássico", checked: false, quantity: 0, price: 6.5 },
        { id: 6, name: "Chocolate", checked: false, quantity: 0, price: 6.5 },
    ]);
        ...
        <div className="w-full max-w-md space-y-6">
            ...
            <ul className="space-y-4 p-6 bg-neutral-300 rounded-md shadow">
                ...
                <li 
                    ...
                    item.checked ? "bg-neutral-200" : "bg-neutral-300 opacity-50"}`}
